        ...
        <main class="el-main" id="view">
            <div data-v-395af661>
                <div data-v-395af661 class="breadcrumbs">
                    <span data-v-395af661 class="breadcrumbs-group">Новый отчет</span>
                </div>
                <div data-v-395af661 class="lc-content-panel">
                    <h1 data-v-395af661 class="title">Редактирования отчета</h1>
                    <form data-v-395af661 class="el-form lc-form" method="post" action="otchet/add_sale.php">
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="text" name="sellerid" id="sellerid" style="min-height: 48px; height: 48px"></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="text" name="productsku" id="productsku"></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="text" name="quantity" id="quantity" onkeypress="return isNumber(event)"></textarea>
                                </div>
                            </div>
                        </div>
                        <?php
                        if($_COOKIE['user2']=='1'):
                            ...
                            <div data-v-395af661 class="el-form-item el-form-item--mini">
                                ...
                                <div class="el-form-item__content" style="margin-left: 200px;">
                                    <div data-v-395af661 class="el-textarea el-input--mini">
                                        <textarea autocomplete="off" class="el-textarea__inner" type="text" name="shop" id="shop"></textarea>
                                    </div>
                                </div>
                            </div>
                        <?php endif?>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <input type="date" name="saledate" id="saledate" class="el-textarea__inner-date">
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661>
