            ...
            <div class="el-row" id="top">
                <div class="row" id="logo" style="min-width: 1vh">
                    <a href="index.php" class="router-link-active" id="homeLink">
                        <img id="logoImg" src="img/logotip.png" alt="PAS" width="128px" height="56px">
                    </a>
                </div>
                <div id="userInfo">
                    <ul class="user-info">
...
$sql = "SELECT saledate, saleid, product, quantity, s_price, seller,store FROM sales
...
<main class="el-main" id="view">
    <div data-v-395af661>
        <div data-v-395af661 class="breadcrumbs">
            <span data-v-395af661 class="breadcrumbs-group">Редактирование отчета о продаже</span>
        </div>
        <div data-v-395af661 class="lc-content-panel">
            <h1 data-v-395af661 class="title">Редактирование отчета о продаже</h1>
            <form data-v-395af661 class="el-form lc-form" method="post" action="otchet/edit_sale.php">
                <input type="hidden" name="saleid" value="<?php echo $sale_id; ?>">
                <div data-v-395af661 class="el-form-item el-form-item--mini">
                    <label for="comment" class="el-form-item__label" style="wight: 200px">Ф.И.О. Продавца</label>
                    <div class="el-form-item__content" style="margin-left: 200px;">
                        <div data-v-395af661 class="el-textarea el-input--mini">
                            <textarea autocomplete="off" class="el-textarea__inner" type="text" name="sellerid" id="sellerid" style="min-height: 48px; height: 48px"><?php echo $row['seller']?></textarea>
                        </div>
                    </div>
                </div>
                <div data-v-395af661 class="el-form-item el-form-item--mini">
                    <label for="outNumber" class="el-form-item__label" style="wight: 200px">Название товара</label>
                    <div class="el-form-item__content" style="margin-left: 200px;">
                        <div data-v-395af661 class="el-textarea el-input--mini">
                            <textarea autocomplete="off" class="el-textarea__inner" type="text" name="productsku" id="productsku"><?php echo $row['product']?></textarea>
                        </div>
                    </div>
                </div>
                <div data-v-395af661 class="el-form-item el-form-item--mini">
                    <label for="outNumber" class="el-form-item__label" style="wight: 200px">Количество</label>
                    <div class="el-form-item__content" style="margin-left: 200px;">
                        <div data-v-395af661 class="el-textarea el-input--mini">
                            <textarea autocomplete="off" class="el-textarea__inner" type="text" name="quantity" id="quantity" onkeypress="return isNumber(event)"><?php echo $row['quantity']?></textarea>
                        </div>
                    </div>
                </div>
                <?php
                if($_COOKIE['user2']=='1'):
                    ?>
                    <div data-v-395af661 class="el-form-item el-form-item--mini">
                        <label for="outNumber" class="el-form-item__label" style="wight: 200px">Магазин</label>
                        <div class="el-form-item__content" style="margin-left: 200px;">
                            <div data-v-395af661 class="el-textarea el-input--mini">
                                <textarea autocomplete="off" class="el-textarea__inner" type="text" name="shop" id="shop"><?php echo $row['store']?></textarea>
                            </div>
                        </div>
                    </div>
                <?php endif?>
                <div data-v-395af661 class="el-form-item el-form-item--mini">
                    <label class="el-form-item__label" style="wight: 200px">Дата</label>
                    <div class="el-form-item__content" style="margin-left: 200px;">
                        <div data-v-395af661 class="el-textarea el-input--mini">
                            <input type="date" name="saledate" id="saledate" value="<?php echo $row['saledate']?>" class="el-textarea__inner-date">
                        </div>
                    </div>
                </div>
                <div data-v-395af661>
                    ...
                    <button data-v-395af661 type="button" class="el-button lc el-button--default" onclick="window.location.href='report.php'">
                        <span>Отменить</span>
                    </button>
                </div>
            </form>
