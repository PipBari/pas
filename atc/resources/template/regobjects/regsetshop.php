        ...
        <main class="el-main" id="view">
            <div data-v-395af661>
                ...
                <div data-v-395af661 class="lc-content-panel">
                    <h1 data-v-395af661 class="title">Регистрация нового магазина</h1>
                    <form data-v-395af661 class="el-form lc-form" method="post" action="regprocess/shopreg.php">
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="text" name="shopname" id="shopname" style="min-height: 48px; height: 48px"></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="text" name="shopadres" id="shopadres"></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" name="login" id="login"></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" name="pass" id="password"></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661>
