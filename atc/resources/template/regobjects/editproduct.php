...
<div id="app">
    <section class="el-container is-vertical" id="mainContainer">
        ...
        <main class="el-main" id="view">
            ...
            $sql = "SELECT p.productid, p.sku, p.productname, p.price,p.storeid,s.storename FROM products p 
        ...
        ";
            ...
            <div data-v-395af661>
                <div data-v-395af661 class="breadcrumbs">
                    <span data-v-395af661 class="breadcrumbs-group">Редактирование информации о продукте</span>
                </div>
                <div data-v-395af661 class="lc-content-panel">
                    <h1 data-v-395af661 class="title">Редактирование информации о продукте</h1>
                    <form data-v-395af661 class="el-form lc-form" method="post" action="regprocess/productedit.php">
                        <input type="hidden" name="productid" value="<?php echo $product_id; ?>">
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            <label for="comment" class="el-form-item__label" style="wight: 200px">Артикул</label>
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="number" name="sku" id="sku" style="min-height: 48px; height: 48px"><?php echo $row['sku']?></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            <label for="outNumber" class="el-form-item__label" style="wight: 200px">Название</label>
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="text" name="pname" id="pname"><?php echo $row['productname']?></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            <label for="outNumber" class="el-form-item__label" style="wight: 200px">Цена за ед.</label>
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="number" name="price" id="price"><?php echo $row['price']?></textarea>
                                </div>
                            </div>
                        </div>
                        <?php
                        if($_COOKIE['user2']=='1'):
                            ...
                            <div data-v-395af661 class="el-form-item el-form-item--mini">
                                ...
                                <div class="el-form-item__content" style="margin-left: 200px;">
                                    <div data-v-395af661 class="el-textarea el-input--mini">
                                        <textarea autocomplete="off" class="el-textarea__inner" type="text" name="shop" id="shop"><?php echo $row['storename']?></textarea>
                                    </div>
                                </div>
                            </div>
                        <?php endif ?>
                        <div data-v-395af661>
                            ...
                            <button data-v-395af661 type="button" class="el-button lc el-button--default" onclick="window.location.href='regnewproduct.php'">
                                <span>Отменить</span>
                            </button>
                        </div>
                    </form>
