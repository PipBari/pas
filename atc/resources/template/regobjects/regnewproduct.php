...
<head>
    ...
    <script src="/atc/src/filter_products.js"></script>
        ...
        <main class="el-main" id="view">
            <div data-v-44f6aa19>
                <div data-v-1ed7fb43 data-v-44f6aa19 class="breadcrumbs">
                    <span data-v-1ed7fb43>Список категории товаров</span>
                </div>
                <div data-v-44f6aa19>
                    <button data-v-44f6aa19 type="button" class="el-button lc el-button--default" onclick="window.location.href='regsetproduct.php'">
                        <span>Регистрация нового товара</span>
                    </button>
                    <button data-v-44f6aa19 type="button" class="el-button lc el-button--default" onclick="filter_product()">
                        <span>Применить фильтрацию</span>
                    </button>
                    <div data-v-44f6aa19 class="lc-table-label">Список товара</div>
        ...
        ";
                            ...
                            <table class="filter-table">
                                ...
                                <?php while($row = mysqli_fetch_assoc($result)) {?>
                                    <?php if($row['storename'] == $_COOKIE['store2'] OR $_COOKIE['store2']==''):?>
                                    <tr class="component__table">
                                        ...
                                        <td>
                                            <form method="post" action="regprocess/productdel.php">
