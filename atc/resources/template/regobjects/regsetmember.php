        ...
        <main class="el-main" id="view">
            <div data-v-395af661>
                <div data-v-395af661 class="breadcrumbs">
                    <span data-v-395af661 class="breadcrumbs-group">Регистрация нового магазина</span>
                </div>
                <div data-v-395af661 class="lc-content-panel">
                    <h1 data-v-395af661 class="title">Редактирования отчета</h1>
                    <form data-v-395af661 class="el-form lc-form" method="post" action="regprocess/memberreg.php">
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="text" name="fullname" id="fullname" style="min-height: 48px; height: 48px"></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="numeric" name="phonenumber" id="phonenumber"></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="text" name="storename" id="storename"></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661>
