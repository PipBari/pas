...
<head>
    ...
    <script src="/atc/src/filter_member.js"></script>
            ...
            <div class="el-row" id="top">
                ...
                <div>
                    <div data-v-60c9bf92 class="nav">
                        ...
                        <div data-v-60c9bf92 class="nav-item notfirst">
                            <a href="registration.php" class="text-center text-decoration-none text-light">Регистрация нового магазина</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="el-main" id="view">
            <div data-v-44f6aa19>
                <div data-v-1ed7fb43 data-v-44f6aa19 class="breadcrumbs">
                    <span data-v-1ed7fb43>Список продавцов</span>
                </div>
                <div data-v-44f6aa19>
                    <button data-v-44f6aa19 type="button" class="el-button lc el-button--default" onclick="window.location.href='regsetmember.php'">
                        <span>Регистрация нового продавца</span>
                    </button>
                    <button data-v-44f6aa19 type="button" class="el-button lc el-button--default" onclick="filter_member()">
                        <span>Применить фильтр</span>
                    </button>
                <div>
                    <div data-v-44f6aa19 class="lc-table-label">Список продавцов</div>
        ...
        ";
                            ...
                            <table class="filter-table">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="phonenumber" onkeypress="return isNumber(event)"></td>
                                ...
                                <?php while($row = mysqli_fetch_assoc($result)) {?>
                                        <tr class="component__table">
                                            ...
                                            <td>
                                                <form method="post" action="regprocess/memberdel.php">
