...
<div id="app">
    <section class="el-container is-vertical" id="mainContainer">
        ...
        $sql = "SELECT s.sellerid, s.fullname, s.phonenumber, s.storeid, st.storename FROM sellers s
        ...
        <main class="el-main" id="view">
            <div data-v-395af661>
                <div data-v-395af661 class="breadcrumbs">
                    <span data-v-395af661 class="breadcrumbs-group">Редактирование информации о продавце</span>
                </div>
                <div data-v-395af661 class="lc-content-panel">
                    <h1 data-v-395af661 class="title">Редактирование информации о продавце</h1>
                    <form data-v-395af661 class="el-form lc-form" method="post" action="regprocess/memberedit.php">
                        <input type="hidden" name="sellerid" value="<?php echo $seller_id; ?>">
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            <label for="comment" class="el-form-item__label" style="wight: 200px">Ф.И.О</label>
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="text" name="fullname" id="fullname" style="min-height: 48px; height: 48px"><?php echo $row['fullname']?></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            <label for="outNumber" class="el-form-item__label" style="wight: 200px">Номер телефона</label>
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="numeric" name="phonenumber" id="phonenumber"><?php echo $row['phonenumber']?></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661 class="el-form-item el-form-item--mini">
                            ...
                            <div class="el-form-item__content" style="margin-left: 200px;">
                                <div data-v-395af661 class="el-textarea el-input--mini">
                                    <textarea autocomplete="off" class="el-textarea__inner" type="text" name="storename" id="storename"><?php echo $row['storename']?></textarea>
                                </div>
                            </div>
                        </div>
                        <div data-v-395af661>
                            <button data-v-395af661 type="submit" class="el-button lc el-button--default" onclick="window.location.href='regmember.php'">
                                <span>Сохранить изменения</span>
                            </button>
                            <button data-v-395af661 type="button" class="el-button lc el-button--default" onclick="window.location.href='regmember.php'">
                                <span>Отменить</span>
                            </button>
                        </div>
                    </form>
