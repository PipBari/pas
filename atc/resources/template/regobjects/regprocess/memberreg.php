...
// Добавляем новый продавца в таблицу stores
$sql = "INSERT INTO sellers (fullname, phonenumber, storeid) 
    VALUES ('$fullname', '$phonenumber','$store_id')";
if ($conn->query($sql) === TRUE) {
    echo "Продавец успешно добавлен";
}
else{
    echo "Чот сломалось";
}
