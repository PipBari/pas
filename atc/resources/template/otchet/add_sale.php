...
// Добавляем новую продажу в таблицу sales

$sql = "INSERT INTO sales (product, seller, store, quantity, saledate,s_price,p_sku) 
        VALUES ('$product_name', '$seller_name', '$store_name', '$quantity', '$date','$product_price','$product_sku')";
